...
STAGES: tuple[tuple[str, Callable[[Path], int]], ...] = (
    ...
    ("cout-residentiel", build.run_cout),
    ("residences-secondaires", build.run_rs),
    ...
    ("foncier-friches", build.run_foncier),
    ("mobilite-residentielle", build.run_mobilite),
    ("mobilite-parc-social", build.run_social),
    ("migrations-residentielles", build.run_migrations),
    ("cout-transaction", build.run_transaction),
    ("scenarios-institutionnels", build.run_institution),
    ("flux-construction", build.run_flux),
)
