...
Article 3 (2026-09-18/19) — le flux (décisions DEC-21..DEC-28, revue
`evidence/revue-contradictoire-2026-09-18-flux.md`) :

- **R-18** (simulé) — Construction et formation de ménages par ZE
  (sortie reproductible `data/processed/flux-construction-menages-ze.json`,
  S-11 × Sitadel en date réelle S-56 × H-21) : lecture estimée 2017-2022,
  398 460 commencés/an en France contre un besoin de flux de 350 689
  (ratio 1,14 ; déclaré 0,98) ; ZE tendues 1,08 (+ 16 131/an, 38 ZE
  déficitaires littorales et alpines ; 1,29 sans RS) — au plancher, le
  ratio est plus haut en ZE tendues (1,11 vs 1,00) et croît avec le
  coût (+ 0,20) ; intensité 11,8 vs 5,9 commencés pour 1 000 logements.
  ANNÉES CLOSES 2023-2024 : − 34 % de commencés, ZE tendues − 58 216/an,
  77 ZE sur 97 en déficit (Toulouse, Bordeaux, Nantes, Montpellier,
  Marseille) ; le stock de détente (1,3 an de formation de ménages)
  serait consommé en 2,9 ans (médiane par ZE) par ce déficit. Lecture :
  **I-18** — la mesure dit ce qu'il a fallu construire pour la croissance
  observée, pas si une formation de ménages a été empêchée ; depuis
  2023, le flux est la contrainte dominante. Limites L-34.
